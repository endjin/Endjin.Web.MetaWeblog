namespace Endjin.Web.MetaWeblog.Installers
{
    ...
    public class RequestMapperFactoryInstaller : IInstaller
    {
        ...
        private void RegisterDefaultContent(RequestMapperFactory requestMapperFactory)
        {
            ...
            requestMapperFactory.RegisterContentFor<XmlRpcRequestToGetRecentPostsRequestMapper>("metaWeblog.getRecentPosts");
            requestMapperFactory.RegisterContentFor<XmlRpcRequestToGetRecentPostsRequestMapper>("metaWeblog.newPost");
        }
    }
}